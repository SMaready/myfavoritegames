...
INSERT INTO games(id, name, genreId, imageUrl) VALUES (3, 'Halo 3: ODST', 1, '/photos/halo_odst_background_image.jpg');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (4, 'Modern Warfare', 1, '/photos/cod4_background_image.jpg');

INSERT INTO games(id, name, genreId, imageUrl) VALUES (5, 'Batman: Arkham', 2, '/photos/arkham_knight_background_image.jpg');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (6, 'Uncharted 3', 2, '/photos/uncharted3_background_image.jpg');

INSERT INTO games(id, name, genreId, imageUrl) VALUES (7, 'FIFA 15', 3, '/photos/fifa15_background_image.jpg');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (8, 'NBA 2K16', 3, '/photos/nba2k16_background_image.jpg');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (9, 'Super Mario Strikers', 3, '/photos/supermariostrikers_background_image.png');

INSERT INTO games(id, name, genreId, imageUrl) VALUES (10, 'Portal 2', 4, '/photos/portal2_background_image.jpeg');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (11, 'Call of the Sea', 4, '/photos/call_of_the_sea_background_image.png');
INSERT INTO games(id, name, genreId, imageUrl) VALUES (12, 'LittleBigPlanet3', 4, '/photos/littlebigplanet_3_background_image.avif');

INSERT INTO games(id, name, genreId, imageUrl) VALUES (13, 'Minecraft', 5, '/photos/minecraft_background_image.webp');
